<ul id="slide-out" class="side-nav nav fixed z-depth-2">
    <li class="center no-padding">
        <div class="darken-2 white-text" style="height: 64px;">
            <div class="row">
                <a href="<%=response.encodeURL("dptdash.jsp")%>" class="brand-logo teal-text"><img src="./images/logo.png" alt="Logo"></a>
            </div>
        </div>
    </li>

    <li id="dash_dashboard"><a class="waves-effect waves-teal teal-text" href="<%=response.encodeURL("dptdash.jsp")%>"><i class="material-icons teal-text">home</i><b>Dashboard</b></a></li>
